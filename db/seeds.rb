...
# demo_friend = { email: 'DemoFriend@demo.com', password: 'password', first_name: 'Friends', last_name: 'Happy', date_of_birth: '05-11-2000', gender: 'female' }
# User.create!(demo_friend)

# more_demo_friends = { email: 'MoreFriends@demo.com', password: 'password', first_name: 'More', last_name: 'Friends', date_of_birth: '02-20-1970', gender: 'male' }
# User.create!(more_demo_friends)

# one_more = { email: 'friendly@demo.com', password: 'password', first_name: 'something', last_name: 'last', date_of_birth: '07-20-1990', gender: 'female' }
